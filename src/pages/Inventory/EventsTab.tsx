                                     ...
                                     <div className="flex gap-2 flex-1 items-center justify-between min-h-0 pl-1">
                                         ...
                                         <div className="shrink-0 flex flex-col items-center justify-center pl-2 pr-1">
                                             <div className="p-1 border-2 border-black bg-white">
                                                 <QRCode value={`${window.location.hostname === 'localhost' ? 'https://print-shop-os.vercel.app' : window.location.origin}/inventory/scan?p=${printingBox.pallet.id}&b=${printingBox.box.id}&i=${printingBox.item.id}`} size={100} level="M" />
                                             </div>
                                         </div>
                                     </div>
                                 </div>
